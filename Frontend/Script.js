...
.logo::before {
    ...
    border:
        1px dashed rgba(0, 234, 255, 0.35);
...
.reactor-glow {
    ...
    animation: reactorGlow 2s ease-in-out infinite;
}
...
.ring-2 {
    ...
    animation:
        rotateReverse 10s linear infinite;
}
...
.system-card:hover {
    ...
    box-shadow:
        0 8px 25px rgba(0, 234, 255, 0.08);
}
